...
// // ✅ Always initialize Stripe correctly
    ...
    return (
      <div className="py-16 container-custom text-center animate-on-load">
        <div className="mx-auto max-w-xl">
          <div className="mb-8 flex justify-center">
            <div className="h-24 w-24 rounded-full bg-success-500/10 flex items-center justify-center">
              <svg viewBox="0 0 24 24" width="48" height="48" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" className="text-success-500">
                <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
                <polyline points="22 4 12 14.01 9 11.01"></polyline>
              </svg>
            </div>
          ...
          <h1 className="text-3xl font-bold mb-4">Payment Successful!</h1>
          <p className="text-gray-600 dark:text-gray-400 mb-2">Your order has been placed successfully.</p>
          <p className="text-gray-600 dark:text-gray-400 mb-8">
            Order ID: <span className="font-medium">{orderId}</span>
          </p>
          <p className="text-gray-600 dark:text-gray-400 text-sm">You will be redirected to your orders page in a moment...</p>
        </div>
      </div>
    )
  }

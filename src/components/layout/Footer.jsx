      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-2">Email: support@ShopHub.com</p>
            <p className="text-gray-600 dark:text-gray-400 mb-2">Phone: +91 (123) 456-7890</p>
            <p className="text-gray-600 dark:text-gray-400">
              Address: Bhopal 462022, Shopping District, M.P 
            </p>
          </div>
        </div>
